...
<Link to="/" className='flex items-centre gap-2 ' onClick={()=>{

setActive("");

// webpage ke sbse upr pe lejane k liye top me 
window.scrollTo(0,0);
...
<p className='text-white text-[18px] font-bold cursor-pointer flex'>Priya &nbsp;<span className='sm:block hidden'>
  {/* sm small device pe hidden rhe  */}
  | Raj</span></p>
...
<div className="sm:hidden flex flex-1 justify-end items-center">
  {/* toggle desides close kb krn ahai and home,about, ye sb kb dikhanna hai */}
